// #1. 헤더공간을 구성 (메뉴 href를 통해 사용자가 원하는 페이지를 불러올 수 있도록 구성하기 위함)
...
const rtRoutes = [
    ...
    {path : "/animal",component : pageAnimal},
    {path : "/history",component : pageHistory},
    {path : "/environment",component : pageEnvironment},
    {path : "/science",component : pageScience},
    {path : "/travel",component : pageTravel},
];
...
const footer = {
    template : `
        <footer>
            <p>Copyrights & copy; National Geograpic ${year}</p>
        </footer>
    `
}
